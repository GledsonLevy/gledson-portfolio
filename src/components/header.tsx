      ...
      {isMobileMenuOpen && (
        <div className="md:hidden border-t border-gray-200/80 dark:border-slate-800/80 bg-[#FAFAFA] dark:bg-[#0F172A] px-4 py-6 shadow-xl">
          <nav className="flex flex-col gap-6 font-mono text-sm tracking-wider uppercase text-gray-600 dark:text-gray-400">
            <a href="#sobre" onClick={() => setIsMobileMenuOpen(false)} className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Sobre</a>
            <a href="#hobbies" onClick={() => setIsMobileMenuOpen(false)} className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Hobbies</a>
            <a href="#formacao" onClick={() => setIsMobileMenuOpen(false)} className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Formação</a>
            <a href="#projetos" onClick={() => setIsMobileMenuOpen(false)} className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Projetos</a>
            <a href="#tecnologias" onClick={() => setIsMobileMenuOpen(false)} className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Tecnologias</a>
          </nav>
        </div>
      )}
    </header>
